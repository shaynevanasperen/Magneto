...
public class MagnetoBuilder(IServiceCollection services)
{
	readonly IServiceCollection _services = services ?? throw new ArgumentNullException(nameof(services));
	...
	/// </summary>
	/// <returns>A reference to this instance after the operation has completed.</returns>
	public MagnetoBuilder WithMemoryCacheStore() => WithCacheStore<MemoryCacheEntryOptions, MemoryCacheStore>();
	...
	/// </summary>
	/// <returns>A reference to this instance after the operation has completed.</returns>
	public MagnetoBuilder WithDistributedCacheStore() => WithDistributedCacheStore<SystemTextStringSerializer>();
	...
	{
		ArgumentNullException.ThrowIfNull(stringSerializer);
	...
	{
		ArgumentNullException.ThrowIfNull(stringSerializerFactory);
	...
	public MagnetoBuilder WithCacheStore<TCacheEntryOptions, TImplementation>(Func<IServiceProvider, TImplementation> cacheStoreFactory)
		where TImplementation : class, ICacheStore<TCacheEntryOptions>
	{
		ArgumentNullException.ThrowIfNull(cacheStoreFactory);
