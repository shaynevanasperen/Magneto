...
{
	protected override void CacheKey(IKey key) => throw new NotImplementedException();
...
{
	public override void Execute(object context) => throw new NotImplementedException();
}
